...
- ⌨️ **Príkazový riadok (CMD/PowerShell/Bash):** 1. Učím sa orientovať bez použitia GUI a byť schopný pohybovať sa v systéme použitím základných príkazov.
                                                  2. Učím sa automatizovať a spúštať rôzne úlohy, ako napríklad jednoduché scripty pre audit systému a siete.
...
- **Scripts:** Moje prvé jednoduché pokusy o automatizáciu bezpečnosti.
- **Home Lab Exercises:** Dokumentácia z konfigurácií siete či rôzne vyriešené problémy v Systéme, ako záznam praktického učenia.
